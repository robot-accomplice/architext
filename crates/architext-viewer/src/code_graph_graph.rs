...
// the fidelity provenance helpers live in `code_graph_provenance.rs` — kept
// out of this file to avoid growing the core graph/badges module past its
// size budget.
...
mod tests {
    ...
    // tested in `code_graph_provenance.rs`.
}
